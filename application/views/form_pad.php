					...
					<form id="userForm" name="userForm" method="POST">
						<div id="_form1" class="row">
							<div class="col-sm-7">
								...
								<div class="form-group border border-5 mt-1 p-4">
									<div id="uraianContainer">
										<div class="uraian-input">
											...
											<input type="text" id="_uraian" class="uraian form-control" name="uraian[]" placeholder="Deskripsi Uraian" value="uraian"><br>
											<input type="number" id="_jumlah" class="jumlah form-control" name="jumlah[]" placeholder="Jumlah" min="0" value="2"><br>
											<input type="text" id="_item" class="item form-control" name="item[]" placeholder="Item" value="item 1"><br>
											<input type="number" id="_harga" class="harga_satuan form-control" name="harga_satuan[]" placeholder="Harga Satuan" min="0" value="1000"><br>
											<input type="number" id="_subtotal" class="subtotal form-control" name="subtotal[]" placeholder="Sub Total" min="0" readonly><br>
									...
									<!-- <button id="_simpan_uraian" class="form-control form-control-sm btn btn-sm btn-primary mt-2"><span class="bx bx-plus"></span> Submit Uraian</button> -->
								</div>
								<br><br>
								<!-- <div class="form-group mt-1">
								...
								<div class="form-group mt-1">
									<button id="_form1_next" class="btn btn-sm btn-primary float-right">Simpan</button>
								</div>
							</div>
						</div>
					</form>
...
<script>
	$(document).ready(function() {
		...
		$("#_harga").on("change", function() {
			jumlah = $("#_jumlah").val();
			harga = $("#_harga").val();
			subtotal = jumlah * harga;
			$("#_subtotal").val(subtotal);
			// $("#_simpan_uraian").prop( "disabled" , "false" );
		});
		...
		$("#userForm").on("submit", function(event) {
			...
			$(".uraian-input").each(function() {
				...
				subtotal = $(this).find(".harga_satuan").val() * jumlah;
			...
			setTimeout(function() {
				window.location.replace("<?= base_url('Database_pad/DB_PAD'); ?>");
			}, 1500);
